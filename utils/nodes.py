...
from utils.tools import get_wikipedia_information
...
def _get_model(model_name: str):
    if model_name == "ollama":
        from utils.llm import get_ollama_models

        llm, _embeddings = get_ollama_models()
    elif model_name == "openai":
        from utils.llm import get_openai_models

        llm, _embeddings = get_openai_models()
    elif model_name == "google":
        from utils.llm import get_gemini_models
